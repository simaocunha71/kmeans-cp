...
int update_clusters_mpi(float* space_x,float* space_y, float* clusters_x,float* clusters_y, int* samples_id, int* clusters_npoints, int nProcesses, int atualRank, MPI_Status status, int N_SAMPLES, int K_CLUSTERS){
...
int update_clusters_ompmpi(float* space_x,float* space_y, float* clusters_x,float* clusters_y, int* samples_id, int* clusters_npoints, int nProcesses, int atualRank, MPI_Status status, int N_SAMPLES, int K_CLUSTERS){
    float sumX[K_CLUSTERS];
    float sumY[K_CLUSTERS];
    float min_dist;
    float dist;
    ...
    for(int n = work_block*atualRank; n < MAX_ITERATIONS; n++) {
        ...
        sumX_par[sample_id_new] += space_x[n];
        sumY_par[sample_id_new] += space_y[n];
